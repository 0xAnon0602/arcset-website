...
function Hydrogen() {
    return (
        ...
        <div>
            ...
            <p className="componentTitle"> Hydrogen </p>
            ...
            <p className="componentText bottomMargin">At CASET, the Hydrogen Energy vertical will drive research and innovation across multiple Technology Readiness Levels (TRLs) to develop scalable, impactful solutions. Key areas of focus include green hydrogen production through electrolysis, thermochemical cycles, photocatalytic processes, and biological methods; efficient hydrogen utilization through fuel cells and green ammonia synthesis; and advancing safe, efficient storage and transportation systems. Aligned with government policies and the national hydrogen mission, this vertical will promote hydrogen’s critical role in achieving emissions reduction targets and enhancing energy security.</p>
